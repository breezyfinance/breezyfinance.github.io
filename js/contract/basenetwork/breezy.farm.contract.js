...
$.BREEZY_FARM = function() {};
$.BREEZY_FARM.prototype = (function() {
    var setting = {
        chainId: null,
        pid: null,
        tokenAction: null,
    ...
    return {
        init: function(options) {
            ...
            BREPrice = configHelper.getPriceByTokenName(setting.chainId, 'bre');
            // this.updateBREPrice();
        ...
        //         BREPrice = data["garbi-protocol"]["usd"];
        //     });
        //     setTimeout(function() {
        //         self.updateGRBPrice();
        //     }, 15000);
        ...
        async GetDataUser(user, chainId, pid) {
            ...
            data["totalMintPerDay"] = coreHelper.parseFloatNumber(parseInt(result["totalMintPerDay_"]) / (10 ** BRE_TOKEN_DECIMAL), BRE_TOKEN_DECIMAL);
        ...
        async GetContractFarmActionToReadData(chainId, pid) {
            ...
            let contractAbi = abiHelper.getBreezyFarmPoolABI();
